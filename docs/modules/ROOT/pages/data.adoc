...
----
<.> Content source root
<.> See xref:../examples/manual_verification_results.yml[]
<.> See xref:../examples/requirements.yml[]
<.> See xref:../examples/reqstool_config.yml[]
<.> See xref:../examples/software_verification_cases.yml[]
...
<.> See xref:yml_examples/requirements_annotations.yml[]
<.> See xref:yml_examples/svcs_annotations.yml[]
...
----
<.> Content source root
<.> See xref:yml_examples/manual_verification_results.yml[]
<.> See xref:yml_examples/requirements.yml[]
<.> See xref:yml_examples/reqstool_config.yml[]
<.> See xref:yml_examples/software_verification_cases.yml[]
<.> See xref:yml_examples/annotations.yml[]
<.> Failsafe Reports root
<.> Surefire Reports root
