...
----
<.> Content source root
<.> See xref:example$manual_verification_results.yml[]
<.> See xref:example$requirements.yml[]
<.> See xref:example$reqstool_config.yml[]
<.> See xref:example$software_verification_cases.yml[]
...
<.> See xref:example$requirements_annotations.yml[]
<.> See xref:example$svcs_annotations.yml[]
...
<.> See xref:example$reqstool_config.yml[]
<.> See xref:example$software_verification_cases.yml[]
<.> See xref:example$annotations.yml[]
<.> Failsafe Reports root
<.> Surefire Reports root
